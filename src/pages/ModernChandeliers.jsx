...
const modernChandelierOptions = [
  {
    name: "Linear Chandelier",
    image: "/assets/Linear Chandelier1.png",
    price: "₹8,499",
    gallery: [
      "/assets/Linear Chandelier1.png",
      "/assets/Linear Chandelier2.png",
      "/assets/Linear Chandelier3.png"
    ],
    details: [
      { label: "Type", value: "Linear" },
      { label: "Material", value: "Metal & Glass" },
      { label: "Feature", value: "Sleek Modern" },
    ],
  },
  {
    name: "Ring Chandelier",
    image: "/assets/Ring Chandelier1.png",
    price: "₹9,499",
    gallery: [
      "/assets/Ring Chandelier1.png",
      "/assets/Ring Chandelier2.png",
      "/assets/Ring Chandelier3.png"
    ],
    details: [
      { label: "Type", value: "Ring" },
      { label: "Material", value: "Metal & Crystal" },
      { label: "Feature", value: "Contemporary" },
    ],
  },
  {
    name: "Geometric Chandelier",
    image: "/assets/Geometric Chandelier1.png",
    price: "₹10,499",
    gallery: [
      "/assets/Geometric Chandelier1.png",
      "/assets/Geometric Chandelier2.png",
      "/assets/Geometric Chandelier3.png"
    ],
    details: [
      { label: "Type", value: "Geometric" },
      { label: "Material", value: "Metal" },
      { label: "Feature", value: "Artistic Shapes" },
    ],
  },
  {
    name: "Sputnik Chandelier",
    image: "/assets/Sputnik Chandelier1.png",
    price: "₹11,499",
    gallery: [
      "/assets/Sputnik Chandelier1.png",
      "/assets/Sputnik Chandelier2.png",
      "/assets/Sputnik Chandelier3.png"
    ],
    details: [
      { label: "Type", value: "Sputnik" },
      { label: "Material", value: "Metal" },
      { label: "Feature", value: "Mid-Century Modern" },
    ],
  },
];

function ModernChandeliers() {
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">Modern Chandeliers Collection</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {modernChandelierOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
...
export default ModernChandeliers;
