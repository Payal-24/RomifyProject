...
const floorMatOptions = [
  {
    name: "Water-Absorbent Floor Mat",
    image: "/assets/Water-Absorbent Floor Mat1.png",
    price: "₹599",
    gallery: [
      "/assets/Water-Absorbent Floor Mat1.png",
      "/assets/Water-Absorbent Floor Mat2.png",
      "/assets/Water-Absorbent Floor Mat3.png"
    ],
    details: [
      { label: "Type", value: "Water-Absorbent" },
      { label: "Material", value: "Microfiber" },
      { label: "Feature", value: "Quick Dry, Non-Slip" },
    ],
  },
  {
    name: "Kitchen Floor Mat",
    image: "/assets/Kitchen Floor Mat1.png",
    price: "₹499",
    gallery: [
      "/assets/Kitchen Floor Mat1.png",
      "/assets/Kitchen Floor Mat2.png",
      "/assets/Kitchen Floor Mat3.png"
    ],
    details: [
      { label: "Type", value: "Kitchen" },
      { label: "Material", value: "PVC & Foam" },
      { label: "Feature", value: "Oil Resistant, Cushioned" },
    ],
  },
  {
    name: "Bathroom Floor Mat",
    image: "/assets/Bathroom Floor Mat1.png",
    price: "₹399",
    gallery: [
      "/assets/Bathroom Floor Mat1.png",
      "/assets/Bathroom Floor Mat2.png",
      "/assets/Bathroom Floor Mat3.png"
    ],
    details: [
      { label: "Type", value: "Bathroom" },
      { label: "Material", value: "Microfiber" },
      { label: "Feature", value: "Super Absorbent, Soft" },
    ],
  },
  {
    name: "Entrance Floor Mat",
    image: "/assets/Entrance Floor Mat1.png",
    price: "₹449",
    gallery: [
      "/assets/Entrance Floor Mat1.png",
      "/assets/Entrance Floor Mat2.png",
      "/assets/Entrance Floor Mat3.png"
    ],
    details: [
      { label: "Type", value: "Entrance" },
      { label: "Material", value: "Coir & Rubber" },
      { label: "Feature", value: "Durable, Dirt Trapper" },
    ],
  },
];
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">Floor Mats Collection</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {floorMatOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <button className="buy-btn" style={{ fontSize: '0.95rem', padding: '7px 18px', borderRadius: 8 }} onClick={() => { setSelectedMat(opt); setQuantity(1); }}>Buy Now</button>
                  </div>
                ))}
              </div>
            ))}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{display: 'flex', gap: 18, marginBottom: 18}}>
                {selectedMat.gallery.map((imgSrc, i) => (
                  <img
                    key={i}
                    src={imgSrc}
                    alt={`${selectedMat.name} ${i+1}`}
                    style={{
                      width: 120,
                      height: 120,
                      borderRadius: 16,
              ...
              <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '1.5rem', letterSpacing: 1}}>{selectedMat.name}</h2>
              <p style={{marginBottom: 12, fontWeight: 600, fontSize: "1.2rem", color: '#7c5a36'}}>MRP {selectedMat.price} <span style={{fontSize: '0.95rem', color: '#888'}}>(incl. tax)</span></p>
              ...
              <div style={{display: 'flex', gap: 18, marginTop: 8, justifyContent: 'center'}}>
                <button
                  ...
                  onClick={() => dispatch({ type: 'ADD_TO_CART', payload: { product: selectedMat, quantity } })}
                >Add to Cart</button>
                <button
                  style={{
                    padding: '10px 28px',
              ...
              {showAR && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{marginBottom: 18, color: '#7c5a36', fontWeight: 500, fontSize: '1.1rem', textAlign: 'center'}}>Scan the QR code below or tap the button to view this floor mat in your room using Augmented Reality (AR) on your mobile device.</p>
                    <model-viewer
                      src={selectedMat?.model}
                      ar
                      ar-modes="scene-viewer quick-look"
                      camera-controls
                      style={{ width: '320px', height: '320px', background: '#fff', borderRadius: '18px', boxShadow: '0 4px 24px #4caf50aa' }}
                      ios-src={selectedMat?.model}
                    ></model-viewer>
                    <a
                      href={selectedMat?.model}
              ...
              {show3D && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '2rem', letterSpacing: 1}}>3D/AR View: Floor Mat</h2>
                    ...
                    <model-viewer
                      src={selectedMat.model || "/3dmodels_mats/mat_sample.glb"}
                      ar
              ...
              <span
                onClick={() => { setSelectedMat(null); setPreviewImg(null); setShow3D(false); setShowAR(false); }}
                style={{
                  position: 'absolute',
                  top: 18,
                  right: 22,
