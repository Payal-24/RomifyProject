...
const lShapedOptions = [
  {
    name: "Standard L-Shaped Sofa",
    image: "/items/L-Shaped.jpg",
    price: "₹24,999",
    gallery: [
      "/items/L-Shaped.jpg",
      "/items/L-Shaped.jpg",
    ...
    model: "/3dmodels3/standard_lshaped_sofa.glb",
    details: [
      { label: "Type", value: "L-Shaped Sofa" },
      { label: "Feature", value: "Spacious, Classic" },
    ],
  },
  {
    name: "Reversible L-Shaped Sofa",
    image: "/items/L-Shaped.jpg",
    price: "₹27,499",
    gallery: [
      "/items/L-Shaped.jpg",
    ...
    model: "/3dmodels3/reversible_lshaped_sofa.glb",
    details: [
      { label: "Type", value: "L-Shaped Sofa" },
      { label: "Feature", value: "Flexible, Reversible" },
    ],
  },
  {
    name: "Left-Hand Facing (LHF) L-Shape",
    image: "/items/L-Shaped.jpg",
    price: "₹26,999",
    gallery: [
      "/items/L-Shaped.jpg",
    ...
    model: "/3dmodels3/lhf_lshaped_sofa.glb",
    details: [
      { label: "Type", value: "L-Shaped Sofa" },
      { label: "Orientation", value: "Left-Hand Facing" },
    ],
  },
  {
    name: "Right-Hand Facing (RHF) L-Shape",
    image: "/items/L-Shaped.jpg",
    price: "₹26,999",
    gallery: [
      "/items/L-Shaped.jpg",
    ...
    model: "/3dmodels3/rhf_lshaped_sofa.glb",
    details: [
      { label: "Type", value: "L-Shaped Sofa" },
      { label: "Orientation", value: "Right-Hand Facing" },
    ],
  },
];

function LShapedCouches() {
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">L-Shaped Couches</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {lShapedOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <button className="buy-btn" style={{ fontSize: '0.95rem', padding: '7px 18px', borderRadius: 8 }} onClick={() => { setSelectedSofa(opt); setQuantity(1); }}>Buy Now</button>
                  </div>
                ))}
              </div>
            ))}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{display: 'flex', gap: 18, marginBottom: 18}}>
                {(selectedSofa.gallery || []).map((imgSrc, i) => (
                  <img
                    key={i}
                    src={imgSrc}
                    alt={`${selectedSofa.name} ${i+1}`}
                    style={{
                      width: 120,
                      height: 120,
                      borderRadius: 16,
              ...
              <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '1.5rem', letterSpacing: 1}}>{selectedSofa.name}</h2>
              <p style={{marginBottom: 12, fontWeight: 600, fontSize: "1.2rem", color: '#7c5a36'}}>MRP {selectedSofa.price} <span style={{fontSize: '0.95rem', color: '#888'}}>(incl. tax)</span></p>
              ...
              {showAR && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{marginBottom: 18, color: '#7c5a36', fontWeight: 500, fontSize: '1.1rem', textAlign: 'center'}}>Scan the QR code below or tap the button to view this sofa in your room using Augmented Reality (AR) on your mobile device.</p>
                    <model-viewer
                      src={selectedSofa?.model || "/3dmodels3/lshaped_sample.glb"}
                      ar
                      ar-modes="scene-viewer quick-look"
                      camera-controls
                      style={{ width: '320px', height: '320px', background: '#fff', borderRadius: '18px', boxShadow: '0 4px 24px #4caf50aa' }}
                      ios-src={selectedSofa?.model || "/3dmodels3/lshaped_sample.glb"}
                    ></model-viewer>
                    <a
                      href={selectedSofa?.model || "/3dmodels3/lshaped_sample.glb"}
              ...
              {show3D && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '2rem', letterSpacing: 1}}>3D/AR View: L-Shaped Sofa</h2>
              ...
              <span
                onClick={() => { setSelectedSofa(null); setPreviewImg(null); setShow3D(false); setShowAR(false); }}
                style={{
                  position: 'absolute',
                  top: 18,
                  right: 22,
