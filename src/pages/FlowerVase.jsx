...
const vaseOptions = [
  {
    name: "Classic Flower Vase",
    image: "/items/flower_vases.jpg",
    price: "₹899",
    gallery: [
      "/items/flower_vases.jpg",
      "/items/flower_vase2.jpg",
      "/items/flower_vase3.jpg"
    ],
    details: [
      ...
      { label: "Feature", value: "Elegant Shape" },
    ],
    model: "/3dmodels2/classic_flower_vase.glb"
  },
  {
    ...
    model: "/3dmodels2/modern_flower_vase.glb"
  },
  {
    ...
    details: [
      ...
      { label: "Finish", value: "Decorative" },
      { label: "Color", value: "Pink" },
      { label: "Feature", value: "Artistic" },
    ],
    model: "/3dmodels2/decorative_flower_vase.glb"
  },
  {
    name: "Tall Flower Vase",
    image: "/items/flower_vases.jpg",
    price: "₹1199",
    gallery: [
      "/items/flower_vases.jpg",
    ...
    details: [
      ...
      { label: "Feature", value: "Tall Design" },
    ],
    model: "/3dmodels2/tall_flower_vase.glb"
  },
];
...
function FlowerVase() {
  ...
  return (
    <section className="tables-page">
      ...
      <h1 className="tables-title">Flower Vase Collection</h1>
