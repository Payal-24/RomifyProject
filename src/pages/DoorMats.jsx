...
const doorMatOptions = [
  {
    name: "Coir Door Mat",
    image: "/assets/Coir Door Mat1.png",
    price: "₹499",
    gallery: [
      "/assets/Coir Door Mat1.png",
      "/assets/Coir Door Mat2.png",
      "/assets/Coir Door Mat3.png"
    ],
    details: [
      { label: "Type", value: "Coir" },
      { label: "Material", value: "Natural Coir" },
      { label: "Feature", value: "Eco-Friendly, Durable" },
    ],
  },
  {
    name: "Rubber Door Mat",
    image: "/assets/Rubber Door Mat1.png",
    price: "₹399",
    gallery: [
      "/assets/Rubber Door Mat1.png",
      "/assets/Rubber Door Mat2.png",
      "/assets/Rubber Door Mat3.png"
    ],
    details: [
      { label: "Type", value: "Rubber" },
      { label: "Material", value: "Rubber" },
      { label: "Feature", value: "Non-Slip, Easy Clean" },
    ],
  },
  {
    name: "Cotton Door Mat",
    image: "/assets/Cotton Door Mat1.png",
    price: "₹299",
    gallery: [
      "/assets/Cotton Door Mat1.png",
      "/assets/Cotton Door Mat2.png",
      "/assets/Cotton Door Mat3.png"
    ],
    details: [
      { label: "Type", value: "Cotton" },
      { label: "Material", value: "Cotton" },
      { label: "Feature", value: "Soft, Absorbent" },
    ],
  },
  {
    name: "Microfiber Door Mat",
    image: "/assets/Microfiber Door Mat1.png",
    price: "₹349",
    gallery: [
      "/assets/Microfiber Door Mat1.png",
      "/assets/Microfiber Door Mat2.png",
      "/assets/Microfiber Door Mat3.png"
    ],
    details: [
      { label: "Type", value: "Microfiber" },
      { label: "Material", value: "Microfiber" },
      { label: "Feature", value: "Quick Dry, Soft" },
    ],
  },
];
  ...
  return (
    <>
      ...
      <section className="chairs-page">
        ...
        <h1 className="chairs-title">Door Mats Collection</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            {[0, 1].map(rowIdx => (
              <div key={rowIdx} style={{ display: 'flex', gap: 32, justifyContent: 'center' }}>
                {doorMatOptions.slice(rowIdx * 2, rowIdx * 2 + 2).map((opt, idx) => (
                  <div
                    key={idx}
              ...
              {showAR && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{marginBottom: 18, color: '#7c5a36', fontWeight: 500, fontSize: '1.1rem', textAlign: 'center'}}>Scan the QR code below or tap the button to view this door mat in your room using Augmented Reality (AR) on your mobile device.</p>
                    <model-viewer
              ...
              {show3D && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{marginBottom: 10, fontFamily: "'Playfair Display', serif", color: '#b86b2a', fontSize: '2rem', letterSpacing: 1}}>3D/AR View: Door Mat</h2>
